...
public class UserDto {
    ...
    public UserDto(String id, String username, String name, String email, String telephoneNo, String gender, Date dateOfBirth, String biography, boolean isPrivate, List<Education> educationList, List<WorkExperience> workExperienceList, List<String> interests, List<String> skills) {
        this.id = id;
