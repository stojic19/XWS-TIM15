...
type Config struct {
	...
	UnblockCommandSubject string
	UnblockReplySubject   string
}
...
func NewConfig() *Config {
	return &Config{
		...
		UnblockCommandSubject: LookupEnvOrGetDefault("UNBLOCK_COMMAND_SUBJECT", "unblock.reply"),
		UnblockReplySubject:   LookupEnvOrGetDefault("UNBLOCK_REPLY_SUBJECT", "unblock.reply"),
	}
}
