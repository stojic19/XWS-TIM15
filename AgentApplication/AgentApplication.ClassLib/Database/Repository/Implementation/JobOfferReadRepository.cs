...
{
    public class JobOfferReadRepository : BaseReadRepository<Guid, JobOffer>, IJobOfferReadRepository
    {
        public JobOfferReadRepository(AppDbContext context) : base(context)
        {
        }
    }
}
